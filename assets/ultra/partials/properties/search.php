...
?>
    <section id="properties-listing" class="rh-page-container container rh-list-full-width rh-ultra-search-page rh-ultra-list-layout-listing <?php echo esc_attr( $ajax_class ) ?>">
        <div class="rh-ultra-search">
            ...
            <div class="rh-ultra-list-wrapper">
				...
				?>
                <div class="rh-ultra-list-box <?php echo esc_attr( 'grid' === $view_type ? ' rh-ultra-grid-box rh-ultra-card-col-3' : '' ); ?> ">
					<?php
