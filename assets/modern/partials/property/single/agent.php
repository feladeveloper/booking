        ...
        if ( isset( $args['agent_title_text'] ) && !empty( $args['agent_title_text'] ) ) {
            ...
            <h3 class="name agent-name">
                ...
                if ( isset( $args['agent_id'] ) && 0 < intval( $args['agent_id'] ) ) {
                    realhomes_agent_verification_badge( $args['agent_id'] );
                }
                ?>
            </h3>
            <?php
                    ...
                    <form id="<?php echo esc_attr( $agent_form_id ); ?>" class="agent-form contact-form-small" method="post" action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>">
                        ...
                        <div class="rh_agent_form__row">
                            ...
                            <div class="agent-form-contact-methods-wrapper">
								...
								<?php if ( isset( $args['agent_mobile'] ) && ! empty( $args['agent_mobile'] ) || isset( $args['agent_whatsapp'] ) && ! empty( $args['agent_whatsapp'] ) ) : ?><?php realhomes_property_agent_contact_methods( $args['agent_mobile'], $args['agent_whatsapp'], 'rh-btn rh-btn-primary submit-button' ); ?><?php endif; ?>
