	...
	function inspiry_enqueue_google_maps() {
		if ( inspiry_is_map_needed() ) {
			...
			if ( is_singular( 'property' ) && ( 'true' == get_option( 'theme_display_google_map' ) ) ) {
				...
				if ( 'modern' === INSPIRY_DESIGN_VARIATION || 'ultra' === INSPIRY_DESIGN_VARIATION && ( inspiry_is_search_page_map_visible() || is_page_template( 'templates/properties-search-half-map.php' ) ) ) {
					inspiry_enqueue_google_map_info_box();
					inspiry_enqueue_google_map_clusterer_spiderfier();
					inspiry_render_multi_properties_google_map();
...
if ( ! function_exists( 'inspiry_render_multi_properties_google_map' ) ) :
	...
	function inspiry_render_multi_properties_google_map() {
		...
		} else if ( is_page_template( array(
		...
		if ( 'all' != $properties_on_the_map ) {
			...
			if ( ( ( is_page_template( array( 'templates/list-layout.php', 'templates/list-layout-full-width.php', 'templates/grid-layout.php', 'templates/grid-layout-full-width.php', 'templates/half-map-layout.php' ) ) || is_tax() ) && $ajax_pagination_enabled ) ) {
