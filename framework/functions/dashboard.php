...
//		);
		...
		if ( is_user_logged_in() ) {
			...
			if ( realhomes_dashboard_module_enabled( 'realhomes_bookings_module_display', 'false' ) ) {
				$menu['bookings'] = array(
					esc_html__( 'Bookings', 'framework' ),
					esc_html__( 'Bookings', 'framework' ),
					'fas fa-calendar-alt'
				);
			}
			...
			$saved_searches_label = get_option( 'realhomes_saved_searches_label', esc_html__( 'My Saved Searches', 'framework' ) );
