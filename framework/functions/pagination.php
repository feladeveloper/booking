...
if ( ! function_exists( 'realhomes_ajax_pagination' ) ) {
	 ...
	 */
	function realhomes_ajax_pagination( $pages = '', $current_query = '' ) {
		...
		if ( 1 != $pages ) {
			...
			if ( ( $paged > 2 ) && ( $paged > $range + 1 ) && ( $pages_to_show < $pages ) ) {
				echo "<a href='" . get_pagenum_link( 1 ) . "' class='" . $page_class . " real-btn-jump' data-page-number='" . 1 . "' data-page-nav='first'>&laquo; " . esc_html__( 'First', 'framework' ) . "</a> "; // First Page
			}

			if ( ( $paged > 1 ) && ( $pages_to_show < $pages ) ) {
				echo "<a href='" . get_pagenum_link( $prev ) . "' class='" . $page_class . " real-btn-jump' data-page-number='" . intval( $prev ) . "' data-page-nav='previous'>&laquo; " . esc_html__( 'Previous', 'framework' ) . "</a> "; // Previous Page
			}
			...
			if ( ( $paged < $pages ) && ( $pages_to_show < $pages ) ) {
				echo "<a href='" . get_pagenum_link( $next ) . "' class='" . $page_class . " real-btn-jump' data-page-number='" . intval( $next ) . "' data-page-nav='next'>" . esc_html__( 'Next', 'framework' ) . " &raquo;</a> "; // Next Page
			}

			if ( ( $paged < $pages - 1 ) && ( $paged + $range - 1 < $pages ) && ( $pages_to_show < $pages ) ) {
				echo "<a href='" . get_pagenum_link( $pages ) . "' class='" . $page_class . " real-btn-jump' data-page-number='" . intval( $pages ) . "' data-page-nav='last'>" . esc_html__( 'Last', 'framework' ) . " &raquo;</a> "; // Last Page
			}
